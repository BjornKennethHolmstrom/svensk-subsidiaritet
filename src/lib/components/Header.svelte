    ...
    <nav class="hidden md:flex items-center gap-8">
      <div class="flex gap-6 font-sans text-sm font-medium text-stone-600">
        ...
        <div class="relative group">
          <a href="/arkitektur/" class="flex items-center gap-1 text-stone-600 hover:text-black transition-colors">
            {$t.architecture.navLabel}
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
            </svg>
          </a>
          <div class="absolute left-0 mt-2 w-64 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 py-2">
            <a href="/arkitektur/spektrum/" class="block px-4 py-2 text-sm text-stone-700 hover:bg-stone-100 hover:text-black">{$t.architecture.pages.spektrum}</a>
            <a href="/arkitektur/matris/" class="block px-4 py-2 text-sm text-stone-700 hover:bg-stone-100 hover:text-black">{$t.architecture.pages.matris}</a>
            <a href="/arkitektur/adaptiv-subsidiaritet/" class="block px-4 py-2 text-sm text-stone-700 hover:bg-stone-100 hover:text-black">{$t.architecture.pages.adaptivSubsidiaritet}</a>
            <a href="/arkitektur/polycentrisk-styrning/" class="block px-4 py-2 text-sm text-stone-700 hover:bg-stone-100 hover:text-black">{$t.architecture.pages.polycentriskStyrning}</a>
            <a href="/arkitektur/meta-styrning/" class="block px-4 py-2 text-sm text-stone-700 hover:bg-stone-100 hover:text-black">{$t.architecture.pages.metaStyrning}</a>
          </div>
        </div>
