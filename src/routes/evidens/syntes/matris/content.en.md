...
## Version 0.3 — provisional by design
...
| H3 | Decentralisation is less likely to improve outcomes when receiving capacity is insufficient. | [S2](/evidens/fall/) documents capacity and local-steering weaknesses; [S5](/evidens/fall/) shows cooperation strengthening small-municipality capacity and specialist access; the [governance factorization tests](/evidens/datamodeller/simuleringar/styrningsfaktorisering/) show widespread sharing of specialist capacity specifically (IT, procurement, environmental inspection, parts of social services, and regional laboratory medicine). | Capacity is multi-dimensional and may interact with architecture. | High | Medium–High | Supported |
...
Basis: S4, S5, comparison with S1, H8/H9, and the [governance factorization tests](/evidens/datamodeller/simuleringar/styrningsfaktorisering/), which found component separation in all sixteen functions examined across two frozen blind tests — the second with a mechanically (hash-)selected sample and with cases beyond the municipal sphere. **Status:** Conditionally supported. **Confidence:** Medium.

*Not High: sixteen functions, a small sample, judgment in the component coding — and the existence of an architecture says nothing about its outcomes.*
...
Basis: the [governance factorization tests](/evidens/datamodeller/simuleringar/styrningsfaktorisering/) — v0.1 produced one clear functional match, two partial ones and three clear mismatches across eight functions. v0.5 improved on its locked predecessor v0.4 on four of six measures in a new blind test, most strongly on binding authority (60.4% → 78.0%), but four sharply local functions still received zero probability of a compatible full architecture. **Status:** Mixed / unresolved, with partial improvement. **Confidence:** Low–Medium.

*No success threshold was preregistered and no chance baseline has been published. The interpretable result is the improvement over the locked predecessor on the same new cases, not the absolute hit percentages.*
...
Basis: S3, S5, H6/H8/H14, GAE coordination mechanisms, and the separation of policy coordination from interface coordination in [governance factorization simulator v0.5](/evidens/datamodeller/simuleringar/styrningsfaktorisering/). **Status:** Conditionally supported. **Confidence:** Medium.
...
### v0.3 — after the second blind test (v0.5)

**Evidence added:** [Can Governance Scale Be Factorized?](/evidens/datamodeller/simuleringar/styrningsfaktorisering/) — a second blind test, with a mechanically hash-selected sample of eight new functions and a six-role architecture.

**Changes:**

| Item | Before | After | Reason |
|---|---|---|---|
| C4a | Conditionally supported, Medium | Status unchanged, new evidence | Component separation replicated across eight new functions, now regional and national as well. Confidence not raised: sixteen cases is still few. |
| C4b | Mixed / unresolved, Low–Medium | Mixed / unresolved with partial improvement, Low–Medium | Binding authority is predicted clearly better than in the previous locked version, but four of eight cases still have zero full-architecture compatibility. |
| C5 | Conditionally supported, Medium | Status unchanged, new evidence | Separating policy from interface coordination produced a measurable improvement — coordination architecture is a design variable in its own right. |
| H5, H7, H9, H14 | Unchanged | New evidence | Supporting but not status-changing. |

---

*Version: v0.3. Corresponds to the initial Swedish case set (S1–S5), research topic R1, and the two frozen governance factorization tests (v0.1 and v0.5).*
