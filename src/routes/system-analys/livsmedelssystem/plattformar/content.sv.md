...
1. **Symbolisk anpassning** – Kedjorna skapar egna "REKO-liknande" funktioner i sina appar, men styr villkoren (prissättning, logistik, datautvinning).
2. **Regulatorisk fångst** – Branschorganisationer lobbar för att definitionen av "lokal mat" ska bli så vid att även centralt producerade varor kvalificerar.
3. **Uppköp** – När en öppen plattform börjar växa, erbjuds grundarna en summa de inte kan tacka nej till.
...
Plattformen kopplas till mobil slakt, kvarnar och fermenteringsenheter (se [förädlingsinfrastruktur](../foradling)) så att små producenter kan samordna logistik och kapacitet. Den blir ryggraden i ett distribuerat livsmedelssystem – inte en ny centraliserad marknadsplats.
