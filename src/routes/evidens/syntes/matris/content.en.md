...
## Version 0.1 — provisional by design
...
Basis: S4, S5, comparison with S1, H8/H9. **Status:** Promising / conditionally supported. **Confidence:** Medium.
...
*Version: v0.1. Corresponds to the initial Swedish case set (S1–S5) and research topic R1.*
