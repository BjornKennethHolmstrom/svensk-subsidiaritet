...
<div class="max-w-4xl mx-auto px-6 py-12" in:fade>
  ...
  <div class="flex justify-between items-center mb-12 pb-6 border-b border-stone-200 dark:border-stone-800">
    ...
    <a href="/downloads/skola-60-minute{$locale === 'sv' ? 'r' : 's'}.pdf" download class="hidden items-center rounded-lg bg-stone-100 px-4 py-2 text-sm font-semibold text-stone-800 transition-colors hover:bg-stone-200 sm:inline-flex">
