  ...
  sv: {
    ...
    evidence: {
      ...
      labels: {
        ...
        r6: "Offentlig finansiering & utjämning",
        r7: "Samordning, komplexitet & ansvar",
        r8: "Medborgarkapacitet & styrning",
        r9: "Styrning & anpassning",
        cases: "Fall",
        s1: "Kommunsammanslagningar (S1)",
        s2: "Skoldecentralisering (S2)",
        s3: "Ädelreformen (S3)",
        s4: "Kommunalekonomisk utjämning (S4)",
        s5: "Mellankommunal samverkan (S5)",
        dataModels: "Data & modeller",
        matt: "Mått",
        beslutsnarhet: "Beslutsnärhet",
        auktoritetsdjup: "Auktoritetsdjup",
        modeller: "GAE-modeller",
        nodvandigVariation: "Nödvändig variation (GAE IV)",
        samordningsskatt: "Samordningsskatt (GAE V)",
        adaptationsflaskhalsen: "Adaptationsflaskhalsen (GAE XV)",
        simuleringar: "Simuleringar",
        aubi: "AUBI-simuleringar",
        styrningsfaktorisering: "Kan styrningens skala faktoriseras?",
        synthesis: "Syntes",
  ...
  en: {
    ...
    evidence: {
      ...
      labels: {
        ...
        r2: "Scale, Capacity & Specialization",
        r3: "Spillovers & Multilevel Governance",
        r4: "Polycentric Governance",
        r5: "Democratic Proximity & Participation",
        r6: "Public Finance & Equalization",
        r7: "Coordination, Complexity & Accountability",
        r8: "Civic Capability & Governance",
        r9: "Governance & Adaptation",
        cases: "Cases",
        s1: "Municipal Mergers (S1)",
        s2: "School Decentralization (S2)",
        s3: "Ädelreformen (S3)",
        s4: "Fiscal Equalization (S4)",
        s5: "Intermunicipal Cooperation (S5)",
        dataModels: "Data & Models",
        matt: "Measures",
        beslutsnarhet: "Decision Proximity",
        auktoritetsdjup: "Authority Depth",
        modeller: "GAE Models",
        nodvandigVariation: "Requisite Variety (GAE IV)",
        samordningsskatt: "Coordination Tax (GAE V)",
        adaptationsflaskhalsen: "The Adaptation Bottleneck (GAE XV)",
        simuleringar: "Simulations",
        aubi: "AUBI Simulations",
        styrningsfaktorisering: "Can Governance Scale Be Factorized?", 
        synthesis: "Synthesis",
