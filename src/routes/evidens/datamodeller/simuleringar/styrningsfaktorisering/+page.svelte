<script>
  ...
  $: trail = [{ label: $t.evidence.navLabel, href: '/evidens/' }, 
              { label: $t.evidence.labels.dataModels, href: '/evidens/datamodeller/' }, 
              { label: $t.evidence.labels.simuleringar, href: '/evidens/datamodeller/simuleringar' },
              { label: $t.evidence.labels.styrningsFaktorisering }];
</script>
